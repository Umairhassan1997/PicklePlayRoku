...
sub fetchData()
 ...
 sub onKeyBoardGroupVisible()
  if m.inputKeyBoardGroup.visible
    m.inputGroup.translation=[1106,254]
 ...
 sub onbtnsqSelect()
  ...
  ' m.apiQr.visible=true
   m.inputGroup.visible=false
  m.apiQr.text="https://api.fbaseller.pro/generate-qr/"+m.top.getScene().Mac
  ?"api url"m.apiQr.uri
  m.apiQr.visible=true
 ...
 function OnkeyEvent(key as string, press as boolean) as boolean
    ...
    else if key="left" and (m.btnsq.hasFocus() or m.btnm3u.hasFocus())
      m.btnInputN.focusfootprintbitmapuri="pkg:/images/btnIpUF.png"
      m.btnsq.setFocus(false)
      m.btnm3u.setFocus(true)   
